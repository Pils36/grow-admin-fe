	...
	return (function(t) {
		...
		3: function(t, e, n) {
			...
			var h = /Edge\/\d+/.test(c),
				...
				m = {
					...
					isFontInstalled: function(t) {
						...
						return (
							(n.font = '200px ' + s(t) + ', "' + e + '"'), o !== n.measureText('mmmmmmmmmmwwwww').width
						);
					},
					...
					(n = [
						...
						},
						{
							...
							value: function() {
								...
								return !i && this[r]
									? this[r].apply(this, e)
									: a && a[r] && a.shouldInitialize() ? a[r].apply(a, e) : void 0;
							}
						}
					]) && mt(e.prototype, n),
					o && mt(e, o),
			...
			function yt(t) {
				...
				return (
					e.moveToElementText(n.node), e.collapse(n.collapseToStart), e.moveStart('character', n.offset), e
				);
			}
			i.a.fn.extend({
				summernote: function() {
					...
					(this.insertParagraph = this.wrapCommand(function() {
						...
						(this.insertNode = this.wrapCommand(function(t) {
							n.isLimited(i()(t).text().length) ||
								(n.getLastRange().insertNode(t), n.setLastRange(wt.createFromNodeAfter(t).select()));
						})),
					...
					(n = [
						{
							...
							value: function(t) {
								...
								e &&
									(t
										? n ? this.$codable.data('cmEditor').getDoc().setValue(t) : this.$codable.val(t)
									...
									this.options.match(e, function(e) {
										if (e) {
											...
											if (
												('string' == typeof e
													? (n = pt.createText(e))
													: e instanceof jQuery ? (n = e[0]) : e instanceof Node && (n = e),
												!n)
											)
												return;
												...
												],
												{
													callback: function(e) {
														e
															...
															.mousedown(
																t.context.createInvokeHandler('editor.insertTable')
															)
